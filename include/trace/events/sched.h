...
TRACE_EVENT(sched_cpu_util,
	...
	TP_printk("cpu=%d nr_running=%d cpu_util=%ld cpu_util_cum=%ld capacity_curr=%u capacity=%u capacity_orig=%u idle_state=%d irqload=%llu online=%u, reserved=%u, high_irq_load=%u nr_rtg_hp=%u",
		...
		__entry->reserved, __entry->high_irq_load,
