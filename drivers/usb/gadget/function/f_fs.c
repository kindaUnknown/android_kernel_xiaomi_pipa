...
static void ffs_user_copy_worker(struct work_struct *work)
{
	struct ffs_io_data *io_data = container_of(work, struct ffs_io_data,
						   work);
	struct ffs_data *ffs __maybe_unused = io_data->ffs;
...
ffs_epfile_open(struct inode *inode, struct file *file)
{
	...
	struct ffs_data *ffs __maybe_unused = epfile->ffs;
...
{
	struct ffs_data	*ffs __maybe_unused = sb->s_fs_info;
	struct inode *inode;
...
{
	struct ffs_epfile *epfile = epfiles;
	struct ffs_data *ffs __maybe_unused = epfiles->ffs;
				...
				void *priv)
{
	...
	struct ffs_data *ffs __maybe_unused = helper->ffs;
				    ...
				    void *priv)
{
	...
	struct ffs_data *ffs __maybe_unused = func->ffs;
						...
						struct usb_configuration *c)
{
	...
	struct ffs_data *ffs __maybe_unused = ffs_opts->dev->ffs_data;
	struct ffs_data *ffs_data;
	int ret;
...
{
	struct ffs_data *ffs __maybe_unused = ffs_func_from_usb(f)->ffs;
